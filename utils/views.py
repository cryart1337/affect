...
class Views:
    class Paginator(discord.ui.View):
        def __init__(self, *,
            ...
            self.previous_button = previous_button or discord.ui.Button(emoji="<:left:1100418278272290846>", style=discord.ButtonStyle.grey)
            self.next_button = next_button or discord.ui.Button(emoji="<:right:1100418264028426270>", style=discord.ButtonStyle.grey)
